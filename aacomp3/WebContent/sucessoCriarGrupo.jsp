...
<body>
	...
	<td width=50 >							
				<br>
		<label>A descricao que aparecerá para os usuários  será</label>	<br>
		<textarea name="regrasGrupo" rows=10 cols=20><%=descricaoGrupo %></textarea> <br><br>
		
		<label>As regras do grupo são</label><br>
		<textarea name="regrasGrupo" rows=10 cols=20><%=regrasGrupo %></textarea> <br><br>
